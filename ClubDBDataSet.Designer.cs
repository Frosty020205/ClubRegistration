...
namespace ClubRegistration.ClubDBDataSetTableAdapters {
...
SELECT ID, StudentID, FirstName, MiddleName, LastName, Age, Gender, Program FROM ClubMembers WHERE (ID = @ID)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::ClubRegistration.Properties.Settings.Default.ClubDBConnectionString;
        }
